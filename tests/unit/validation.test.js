...
describe("validateAuthConfig", () => {
    ...
    it("returns error for placeholder client ID", () => {
        ...
        expect(result).toBe("Add your Google OAuth Web Client ID in config.js before signing in.");
    });
    ...
    it("returns error for file:// protocol", () => {
        ...
        expect(result).toBe("Open the app through a local server like http://localhost:5500, not as a file:// page.");
    });
});
